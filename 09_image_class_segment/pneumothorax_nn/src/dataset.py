...
class ClassificationDataset:
    ...
    """
    def __init(self, image_paths, targets, resize=None, augmentations=None):
        """
    ...
    def __getitem__(self, item):
        ...
        # convert image to RGB, we single channel images
        ...
        if self.resize is not None:
            image = image.resize((self.resize[1], self.resize[1]),
