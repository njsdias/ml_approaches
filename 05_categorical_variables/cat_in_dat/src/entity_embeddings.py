...
def create_model(data,catcols):
    ...
    for c in catcols:
        ...
        # embedding size is always 1 more than unique values input
        out = layers.Embedding(num_unique_values+1,  # input dim
                               embed_dim,            # output dim
                               name=c)(inp)
    ...
    # compile the model
    # we see adam and binary cross entropy
